...
CREATE TABLE IF NOT EXISTS `itechart_group_db`.`car_park` (
  ...
  `car_name` VARCHAR(45) NULL DEFAULT NULL,
  `car_number` VARCHAR(45) NULL DEFAULT NULL,
  `car_type` ENUM('Carcase', 'Fridge', 'Tank') NULL DEFAULT NULL,
  `car_consumption` INT NULL DEFAULT NULL COMMENT 'the using up of a diesel',
  PRIMARY KEY (`idcar`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `itechart_group_db`.`items` (
  ...
  `item_type` ENUM('Count', 'Volume') NULL DEFAULT NULL,
  PRIMARY KEY (`iditem`))
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `itechart_group_db`.`users` (
  ...
  `user_middlename` VARCHAR(45) NULL DEFAULT NULL,
  `user_birthday` DATE NULL DEFAULT NULL,
  `user_email` VARCHAR(45) NULL DEFAULT NULL,
  `user_city` VARCHAR(45) NULL DEFAULT NULL,
  `user_street` VARCHAR(45) NULL DEFAULT NULL,
  `user_house` VARCHAR(45) NULL DEFAULT NULL,
  `user_apartment` INT NULL DEFAULT NULL,
  `user_role` ENUM('sysadmin', 'admin', 'manager', 'dispatcher', 'driver', 'owner') NULL DEFAULT NULL,
  `user_login` VARCHAR(45) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `itechart_group_db`.`warehouses` (
  ...
  `warehouse_name` VARCHAR(45) NULL DEFAULT NULL,
  `warehouse_country` VARCHAR(45) NULL DEFAULT NULL,
  `warehouse_city` VARCHAR(45) NULL DEFAULT NULL,
  `warehouse_street` VARCHAR(45) NULL DEFAULT NULL,
  `warehouse_house` VARCHAR(45) NULL DEFAULT NULL,
  `warehouse_lat` VARCHAR(45) NULL DEFAULT NULL,
  `warehouse_lng` VARCHAR(45) NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `itechart_group_db`.`invoices` (
  ...
  `users_iduser_inspector` INT NULL DEFAULT NULL,
  `waybills_idwaybill` INT NULL DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `itechart_group_db`.`checkpoints` (
  ...
  `checkpoint_name` VARCHAR(45) NULL DEFAULT NULL,
  `checkpoint_lat` VARCHAR(45) NULL DEFAULT NULL,
  `checkpoint_lng` VARCHAR(45) NULL DEFAULT NULL,
